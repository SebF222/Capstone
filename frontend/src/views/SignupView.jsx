  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!signupResponse.ok) {
        setErrors({ submit: signupResult.error || 'An error occurred during signup' });
        setIsLoading(false);
        return;
      }
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: '1rem' }}>
              <p style={{ fontSize: '0.875rem', color: '#6b7280' }}>
                ...
                <useNavigate to="/login" style={{ color: '#2563eb', textDecoruseNavigatetion: 'none', fontWeight: '500' }}>
                  Log in
                </useNavigate>
              </p>
            </div>
